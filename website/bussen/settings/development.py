...
import os
from bussen.settings import *  # noqa
...
LOGGING = {
    ...
    "handlers": {"console": {"level": "INFO", "class": "logging.StreamHandler",},},  # noqa  # noqa
    "loggers": {"": {"handlers": ["console"], "level": "INFO", "propagate": True,},},  # noqa  # noqa
}
